...
//  Салбар, байршлын тогтмол жагсаалт
//
//  Бүртгүүлэх болон профайл засах маягтад ашиглана.
//  Нэвтрэх шаардлагагүй — бүртгүүлэхээс өмнө хэрэгтэй.
// =====================================================

const router = require('express').Router();
const pool   = require('../db');

// Жагсаалт ховор өөрчлөгддөг тул санах ойд хадгална
let cache = null;
let cachedAt = 0;
...
/** Жагсаалт өөрчлөгдсөн үед кэшийг цэвэрлэнэ */
